...
if not os.path.exists("src/Gráficos e Raspagem de Dados/Gráficos Sintomas"):
    os.mkdir("src/Gráficos e Raspagem de Dados/Gráficos Sintomas")
...
for cidade in cidades:
    for cap in caps:
        ...
        anosg = []
        for ano in anos:
            df = pd.read_csv(f"src/Gráficos e Raspagem de Dados/.Tabelas Internações/dados cid10 {ano}.csv", sep=";", encoding="utf-8")
            ...
            if len(anosg) == 4:
                ...
                fig.show()
                fig.write_image(f"src/Gráficos e Raspagem de Dados/Gráficos Sintomas/Casos de Internações_{capsdesc[caps.index(cap)]}-{cidade[7:]}.png")
            else:
                pass
