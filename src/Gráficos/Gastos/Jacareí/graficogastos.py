...
for ano in ANOS:
    valores = []
    df = pd.read_csv(f'C:/Users/Wellington/Documents/GitHub/API/src/Gráficos/Gastos/Jacareí/Gastos{ano}/detalhamentoDespesas{ano}.csv', sep=';') 
...
fig.write_image('C:/Users/Wellington/Documents/GitHub/API/src/Gráficos/Gastos/Jacareí/GráficoGastosporAnoJacarei.svg')