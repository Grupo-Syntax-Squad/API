...
if not os.path.exists("C:/Users/Fatec/Documents/GitHub/API/src/Gráficos/Gráficos Sintomas"):
    os.mkdir("C:/Users/Fatec/Documents/GitHub/API/src/Gráficos/Gráficos Sintomas")
...
for cidade in cidades:
    for cap in caps:
        ...
        anosg = []
        for ano in anos:
            df = pd.read_csv(f"C:/Users/Fatec/Documents/GitHub/API/src/Gráficos/.Tabelas Internações/dados cid10 {ano}.csv", sep=";", encoding="utf-8")
            ...
            if len(anosg) == 4:
                ...
                fig.show()
                fig.write_image(f"C:/Users/Fatec/Documents/GitHub/API/src/Gráficos/Gráficos Sintomas/Casos de Internações_{capsdesc[caps.index(cap)]}-{cidade[7:]}.png")
            else:
                pass
